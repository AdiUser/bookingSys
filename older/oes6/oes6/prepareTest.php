        ...
        ?>
            ...
            <div id="<?php echo $row[0]; ?>qs">
                <form id='form-0' style="width:100%;" >
                    ...
                    <?php if($row[2]) {
					// -----Image Handling using DATA URI--------
					$fileContents = file_get_contents("image_data/$row[2]");
					if($fileContents !== false) {
						...
						echo "<p style='text-align:center; overflow:auto;' ><img src='".$dataUri->toString()."' /></p>";
					  }
					} ?>
                    <?php
					if($row[9] == "MC")
					{
					?>
					<table border='0' width='auto' class='ntab'>
